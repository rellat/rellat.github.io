// Rellat Prototype Demo: Reply widget for CodeMirror
// by Chase Lee
/* global CodeMirror */

function RLReply(editor) {
  this.editor = editor;
  this.RLReplyContainer = { //댓글을 저장하는 전역변수이다.
    replies: [], // 댓글 오브젝트를 저장하는 배열이다.
    // reply { person, level, order, containerID, containerParent, widget }
    reinputs: [], // 댓글입력노드를 저장하는 배열이다.
    // replyInput { person, containerID, containerParent, textID, widget }
